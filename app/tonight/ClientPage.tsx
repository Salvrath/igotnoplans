    ...
    <main className="min-h-screen bg-zinc-950 text-zinc-50">
      <div className="mx-auto max-w-3xl px-4 py-10">
        <header className="mb-8">
          ...
          <h1 className="mt-2 text-4xl font-semibold tracking-tight">No plans tonight?</h1>
          <p className="mt-3 text-zinc-300">Get an instant idea and make tonight count.</p>
        </header>
        ...
        <section className="mt-6">
          {current ? (
            <div className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6">
              ...
              <div className="mt-6 text-sm text-zinc-400">Tip: send the link to decide together.</div>
            </div>
          ) : (
